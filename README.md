# abdul-gani_19630959_4f-REGmalam_PBO
project akhit mata kuliah PBO1
...
```bash
public class kedai kopi {
    ...
}

public class keadai kopiDetail extends kedaikopi {
    ...
}
...
```bash
mhs[i] = new MahasiswaDetail(nama, pesanan);
```
...
public void setNpm(String pesanan) {
...
```bash
public class menupesanDetail extends menu {
    ...
}
```
...
public String getFakultas() {
    ...
    //return getNpm().substring(2, 4).equals("10") ? "americano" : "menu tidak ada";
}

public String getProdi() {
    switch(nama pemesan().substring(4, 6)) {
        case "01":
            return "pesanan pemesan";
        case "02":
            return "jumblah pesanan";
        default:
            return "total";
    }
}
...
System.out.println("\nData pesanan:");
System.out.println(pesanan.displayInfo());
```

13. **Array** adalah struktur data yang digunakan untuk menyimpan beberapa nilai dalam satu variabel. Pada kode ini, `MahasiswaDetail[] mahasiswas = new MahasiswaDetail[2];` adalah contoh penggunaan array.

```bash
pesananDetail[] pesanans = pesanan Detail[2];
```
